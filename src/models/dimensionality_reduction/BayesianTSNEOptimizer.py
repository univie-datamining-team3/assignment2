...
class BayesianTSNEOptimizer:
    ...
    def run(self, num_iterations: int, init_values: dict = None, init_fraction: int = 0.2, kappa: int = 10):
        """
        ...
        :param init_values: Dictionary with initialization values (strucutured like BayesianOptimization.res['all']).
        :param init_fraction: Fraction of total number of data points to be generated via random initialization.
        :param kappa: Exploration parameter for Bayesian optmization.
        ...
        num_init_points = max(int(num_iterations * init_fraction), 1)
